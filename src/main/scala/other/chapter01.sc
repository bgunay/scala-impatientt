...
//
// In scala, everything is an object, even an integer. `3` is of type `Int`, which defines a lot of functions and operators.
// See the [Int class](http://www.scala-lang.org/api/2.7.2/scala/Int.html) in the scala doc for a complete list.
3       //> res: Int = 3
