...
object chapter19 extends App {
  ...
  class FluentBug() {
    ...
    def move(distance: Int): FluentBug = {
      position += distance * direction; this
    }
    ...
    def turn(obj: around.type): FluentBug = {
      direction = -direction; this
    }

    def doShow(): FluentBug = {
      /*println(position);*/ this
    }

    def and(obj: thén.type): FluentBug = this

    def and(obj: show.type): FluentBug = {
      doShow(); this
    }
  }
  ...
  class Document(var title: String, var author: String = "Unknown") {
    ...
    def set(obj: Title.type): Document = {
      attr = obj; this
    }

    def set(obj: Author.type): Document = {
      attr = obj; this
    }
